...
function add_record() {
    ...
    let ass1_value = document.getElementById("assignment1").value;
    let ass2_value = document.getElementById("assignment2").value;
    let labs_value = document.getElementById("labs").value;
    let midterm_value = document.getElementById("midterm").value;
    let final_value = document.getElementById("final").value;


    if ((name_value==="")||(id_value==="")||(gpa_value==="")||(ass1_value==="")||(ass2_value==="")||(labs_value==="")||(midterm_value==="")||(final_value==="")){
        return null;
    }
    ...
    ass1_value = "<td>" + ass1_value + "</td>";
    ass2_value = "<td>" + ass2_value + "</td>";
    labs_value = "<td>" + labs_value + "</td>";
    midterm_value = "<td>" + midterm_value + "</td>";

    final_value = "<td>" + final_value + "</td>";

    let newRow = "<tr>"+name_value+id_value+gpa_value
                       +ass1_value+ass2_value+labs_value+midterm_value+final_value+"</tr>";
    ...
    document.getElementById("assignment1").value = null;
    document.getElementById("assignment2").value = null;
    document.getElementById("labs").value = null;
    ...
    fetch("http://localhost:8080/lab6-1.0/api/students/json").then((x) => {
        x.json().then((y) =>{
            ...
            for (const k of y.students) {
                ...
                let ass1_value = "<td>" + k.assignment1 + "</td>";
                let ass2_value = "<td>" + k.assignment2 + "</td>";
                let labs_value = "<td>" + k.labs + "</td>";
                let midterm_value = "<td>" + k.midterm + "</td>";
                let final_value = "<td>" + k.final + "</td>";
